Основная идея проекта - сделать быть проще с помощью отслеживания необходимых продуктов внутри приложения вместе с семьей, коллегами, друзьями или самим собой.
Для прототипа был разработан базовый функционал:
...
- Создание групп двух видов:
  1) публичных (для двух и более человек)
  ...
  2) личных (только для пользователя)
  <img width="1278" height="339" alt="создание личной группы" src="https://github.com/user-attachments/assets/935540cd-a0b8-4a5e-96ba-ba25eeef6f95" />
  Вид с главной страницы:
...
- Редактирование ранее созданных групп
<img width="1271" height="488" alt="редактор" src="https://github.com/user-attachments/assets/b05cab1f-0ff1-4987-b9b3-1c96806aba30" />

- Изменение текущего списка продуктов:
  1) выбрать продукт из уже ранее созданных и отредактировать его данные
  ...
  2) добавить продукт, которого нет в списке
